...
## Adatlap tulajdonosa / felelőse

Amikor olyan JSON-nal hozol létre vagy módosítasz adatlapot, amely tartalmazza a felelős felhasználó nevét, a működés a következő:
...
Ezzel az API-logikával kevesebb hiba keletkezik a kéréseknél, és hatékonyabb az adatfeldolgozás, mivel a hiányzó adatlapok száma minimális lesz, ahelyett, hogy a rendszer hibaüzenetet adna vissza, és elírások miatt nem hozna létre adatlapot.

---

## Adatlap áthelyezése ugyanahhoz a céghez kapcsolt másik kapcsolattartóra
